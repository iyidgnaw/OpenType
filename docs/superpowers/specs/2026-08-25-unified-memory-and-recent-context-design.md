...
| 位置 | 现状 |
|---|---|
| `USER_GUIDE.md` §115 表格、§184、§257、§446、§566、§593 | 六处明文 |
| `README.md` / `README.zh-CN.md` | 特性描述 |
| `opentype-site`（独立仓库，opentype-site.vercel.app）`i18n.js` §38/68/72、`index.html` §18/232/262 | 中英各一套 |
